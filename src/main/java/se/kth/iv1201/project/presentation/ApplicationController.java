...
public class ApplicationController {
    ...
    public String application(CompetenceForm competenceForm, AvailabilityForm availabilityForm ,Model model) throws IllegalApplicationException{
       if(currentUser==null){
    ...
    public String availability(CompetenceForm competenceForm, AvailabilityForm availabilityForm ,Model model) throws IllegalApplicationException{
       if(currentUser==null){
        throw new IllegalApplicationException("No user logged in.");
    }
       else{
    ...
    public String summary(CompetenceForm competenceForm, AvailabilityForm availabilityForm ,Model model) throws IllegalApplicationException{
       if(currentUser==null){
        throw new IllegalApplicationException("No user logged in.");
    }
       else{
    ...
    public String confirmCompetence(CompetenceForm competenceForm, AvailabilityForm availabilityForm ,Model model) throws IllegalApplicationException{
        return "availability";
    }
